...
Bort is a base Rails 2.3 application that makes creating new projects easier and faster. Bort is developed and maintained by "Fudge Studios":http://www.fudgestudios.com, "Jim Neath":http://jimneath.org and "Matt Hall":http://matthall.wordpress.com. This is Gordon Isnor’s Bort fork, http://www.isnorcreative.com. 
...
h3. Rspec & Rspec-rails, Cucumber

You should be testing your code, so Bort comes with Rspec and Rspec-rails, and Cucumber already installed so you're
ready to roll.

h3. Hoptoad

You don't want your applications to crash and burn so Hoptoad is already installed to let 
